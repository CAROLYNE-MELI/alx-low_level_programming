...
/**
 * check_elf - checks if a file is an elf fil
...
/**
 * print_abi - Prints ABI version of an ELF.h
 * @e_ident: pointer to an array with the ELF.h ABI version
 * Return: void
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_type - prints type of an ELf.h
 * @e_type: ELF.h type
 * @e_ident: pointer to an array with elf.h type
 * Return: void
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * print_entry - prints the entry point of an ELf.h
